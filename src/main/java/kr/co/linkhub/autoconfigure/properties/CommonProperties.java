...
public class CommonProperties implements PopbillProperties{
    ...
    private boolean useSeparateConfig;
    ...
    public boolean isUseSeparateConfig() {
        return useSeparateConfig;
    }

    public void setUseSeparateConfig(boolean useSeparate) {
        useSeparateConfig = useSeparate;
    }
}
